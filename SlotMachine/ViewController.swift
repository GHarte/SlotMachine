...
//  SlotMachine
//
//  Created by Gareth Harte on 11/10/2014.
...
class ViewController: UIViewController {
    ...
    //Constants for creating views programmatically
    ...
    func setupContainerViews(){
        ...
        self.fourthContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: self.firstContainer.frame.height + secondContainer.frame.height + thirdContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * kSixth))
    ...
    func setUpFirstContainer(containerView: UIView) {
        ...
        self.titleLabel.font = UIFont(name: "Noteworthy", size: 40)
    ...
    func removeSlotImageViews () {
        ...
        if self.secondContainer != nil {
            ...
            for view in subViews! {
                view.removeFromSuperview() //remove subviews (imageViews) from second container
            }
        }
    ...
    func hardReset() {
        removeSlotImageViews()
        slots.removeAll(keepCapacity: true) //keep memory, going to need the same capacity for slots array every time spin button is pressed
